...
public class VarargsMethodInvocation {

	public VarargsMethodInvocation() {
	...
	private static <T> void displaywithoutSafeVarargs(T... lists) {
		...
		for (T element : lists) {
			...
			System.out
					.println("Display of elements without @SafeVarargs Annotation");
	...
	private static <T> void displaywithSafeVarargs(T... lists) {
		...
		for (T element : lists) {
			...
			System.out
					.println("Display of elements with @SafeVarargs Annotation");
			System.out.println(element.getClass().getName() + ": " + element);
